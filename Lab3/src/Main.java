public class Main {
    public static void main(String[] args) {
        ...
        //PENTRU V2
        retea.getNode(1).setCost(v1,10); //v2-v1
        retea.getNode(1).setCost(v3,20); //v2-v3
        retea.getNode(1).setCost(v4,20); //v2-v4
        retea.getNode(1).setCost(v5,20); //v2-v5

        //PENTRU V3
        retea.getNode(2).setCost(v1,50); //v3-v1
        retea.getNode(2).setCost(v2,20); //v3-v2
        retea.getNode(2).setCost(v4,10); //v3-v4

        //PENTRU V4
        retea.getNode(3).setCost(v2,20); //v4-v2
        retea.getNode(3).setCost(v3,10); //v4-v3
        retea.getNode(3).setCost(v5,30); //v4-v5
        retea.getNode(3).setCost(v6,10); //v4-v6

        //PENTRU V5
        retea.getNode(4).setCost(v2,20); //v5-v2
        retea.getNode(4).setCost(v4,30); //v5-v4
        retea.getNode(4).setCost(v6,20); //v5-v6

        //PENTRU V6
        retea.getNode(5).setCost(v4,10); //v6-v4
        retea.getNode(5).setCost(v5,20); //v6-v5

        retea.printNetworkMap();

        retea.buildNodesIdentifiable();
        retea.printNodesIdentifiable();


        retea.shortestsTimes();
